                ...
                <div class="card full-height">
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-wrap justify-content-around pb-2 pt-4">
                            ...
                            <form action="{{ route('clientes.store') }}" method="POST" onsubmit="return todocedula()"
                                        ...
                                        <div class="card full-height">
                                            ...
                                            <div class="card-body">
                                                <ol class="activity-feed">
                                                    ...
                                                    <li class="feed-item feed-item-success">
                                                        <div class="row">
                                                            <time class="date" datetime="9-25">Servicio por Radio o fibra</time>
                                                            <select class="chosen-select form-control" name="servicio" data-placeholder="Sucursal">
                                                    ...
                                                    <li class="feed-item feed-item-secondary">
                                                        <div class="row">
                                                            ...
                                                            <input type="text" name="gps" class="form-control" placeholder="GPS" value="{{ old('gps') }}">
                                                            @error('gps')
                                                                <div class="alert alert-danger" role="alert">
                                                                    <small>{{ $message }}</small>
                                                                </div>
                                                    ...
                                                    <li class="feed-item feed-item-secondary">
                                                        <div class="row">
                                                            ...
                                                            <input type="file" name="fcedula1" accept="image/*" class="form-control imagejs"
                                                    ...
                                                    <li class="feed-item feed-item-success">
                                                        <div class="row">
                                                            ...
                                                            <input type="file" name="fcedula2" accept="image/*" class="form-control imagejs"
                                                                placeholder="Correo Electronico"  value="{{ old('email') }}">
                                                            @error('fcedula2')
                                                                <div class="alert alert-danger" role="alert">
                                                                    <small>{{ $message }}</small>
