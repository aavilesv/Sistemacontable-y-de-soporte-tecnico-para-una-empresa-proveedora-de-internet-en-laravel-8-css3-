...
@section('content')
                    ...
                    <div class="card full-height">
                        ...
                        <div class="card-category"><i class="fas fa-align-justify"></i> Registar</div>
                            <div class="d-flex flex-wrap justify-content-around pb-2 pt-4">
                                <form action="{{ route('rhcargos.update',$rrhcargo) }}" method="POST"  class="form-control">
                                    @csrf
                                    @method('put')
                                    <div class="form-group">
                                        ...
                                        class="form-control" placeholder="Nombre"
                                               value="{{old('nombre',$rrhcargo->nombre)}}">
                                        @error('nombre')
        ...
        <a href="{{route('rhcargos.index')}}" class="btn btn-danger btn-border btn-round mr-2"><i class="fas fa-reply"></i> Cancelar</a>
